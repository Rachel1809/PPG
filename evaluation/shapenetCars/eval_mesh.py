...
def evaluate_mesh(gt_path, es_path, n_points=100000, normalize=False):
    ...
    print("chamferl2: %.4f"%(result['chamfer-L2']*10000))
    print("f-score-0.005: %.4f"%(result['f-score-0.005']))
    print("f-score-0.01: %.4f"%(result['f-score-0.01']))
    print('nc:%.4f'%(result['normals completeness']))
