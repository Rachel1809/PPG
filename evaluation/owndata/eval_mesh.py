...
def evaluate_mesh(gt_path, es_path, input_path, log_file, n_points=100000, normalize=False):
    ...
    if gt_path in gt_cache.keys():
        ...
        if os.path.splitext(gt_path)[-1]=='.xyz': 
            ...
            if isinstance(gt_mesh, trimesh.Trimesh):
                gt_pointcloud, idx = trimesh.sample.sample_surface_even(gt_mesh, n_points)
    ...
    # es_mesh.export("/workspace/es_mesh.ply")
    ...
    print('Chamfer-L1:', result['chamfer-L1'] * 100)
    print('Chamfer-L2:', result['chamfer-L2'] * 100)
    print('F-score:', result['f-score'])
    print('Hausdorff:', result['hausdorff'])
...
if __name__ == '__main__':
    ...
    evaluator=MeshEvaluator(n_points=10000)
    ...
    evaluate_mesh(gt_file, pred_file, input_file, log_file=log_file, n_points=10000)
